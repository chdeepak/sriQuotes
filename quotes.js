...
var quotes = [
    ...
    { "quoteId":"4", "quoteMessage":"When we get in touch with the source of life then all other tensions, worries fall off and we can sing, dance and be happy. Life can become very intense, intense in the sense of being joyful." },
    { "quoteId":"5", "quoteMessage":"Your bondage to the Master, to the Truth, to the ancient Knowledge of the Rishis is your saviour." },
    { "quoteId":"6", "quoteMessage":"The mind looks for something new. The heart longs for the old. Life is a blend of both."},
    { "quoteId":"7", "quoteMessage":"Use anger as a tool but don’t be a tool of anger."},
    { "quoteId":"8", "quoteMessage":"Just wake up and see that you are beautiful. The innocence in you is so beautiful. The dance in you is so beautiful."}
    ];
  var images = [
